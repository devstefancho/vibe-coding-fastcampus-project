...
3. 장바구니 담기 기능 분석 및 개선

```
> 장바구니 담기 기능 개선점 확인해줘, 개선 진행해줘
```

4. 사용성 개선하기 (Alert -> Toast 컴포넌트로 전환)

```
> alert을 사용하고 있는 부분들을 확인해서 알려줘
```

5. 좋아요(favorite) 버튼 전역 상태 관리하기

```
>
```

6. 상품 이미지 돋보기 기능 추가하기
